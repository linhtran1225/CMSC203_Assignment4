...
public class MgmCompanyGUI extends Application {
	...
	private Property buildPropertyWithGivenPlot() {
		...
		try {
			p = new Property(propNameText.getText(), propCityText.getText(),
					propOwnerText.getText(),Double.parseDouble(propRentText.getText()), Integer.parseInt(propPlotXText.getText()),
			...
			p = new Property(propNameText.getText(), propCityText.getText(),
					propOwnerText.getText(), Double.parseDouble("1000.0"));
		}
